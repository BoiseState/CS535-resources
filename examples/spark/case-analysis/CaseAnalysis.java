...
/** 
 *Calculate the percentage capitalization for each letter A-Z.
 * @author: amit 
 **/
...
public final class CaseAnalysis {
	public static void main(String[] args) throws Exception {
		...
		JavaPairRDD<String, Double> x = 
				total.mapToPair(s -> {return new Tuple2<>(s._1, 100*(double)s._2._1/s._2._2);});
		printRDD3(x);
