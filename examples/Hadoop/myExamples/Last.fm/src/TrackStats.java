...
public class TrackStats implements WritableComparable<TrackStats> 
{
	...
	public TrackStats(IntWritable numListeners, IntWritable numPlays,
			IntWritable numScrobbles, IntWritable numRadio, IntWritable numSkips) {
	...
	@Override
	public int hashCode() {
		return listeners.hashCode() * 163 + plays.hashCode()
				+ scrobbles.hashCode() + radioPlays.hashCode()
				+ skips.hashCode();
	}
	...
	public boolean equals(Object o) {
		if (o instanceof TrackStats) {
			...
			return listeners.equals(ts.listeners) && plays.equals(ts.plays)
					&& scrobbles.equals(ts.scrobbles)
					&& radioPlays.equals(ts.radioPlays)
					&& skips.equals(ts.skips);
		}
		return false;
	}
	...
	public String toString() {
		return listeners + " " + plays + " " + scrobbles + " " + radioPlays
				+ " " + skips;
	}
