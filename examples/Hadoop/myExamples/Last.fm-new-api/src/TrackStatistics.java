...
public class TrackStatistics implements Writable 
{
	...
	public TrackStatistics(int userId, int trackId, int scrobble,
			int radioPlay, int skip) {
		this.userId = userId;
	...
	/**
	 * @param scrobble the scrobble to set
	 */
	...
	/**
	 * @param radioPlay the radioPlay to set
	 */
	...
	public String toString() {
		return userId + " " + trackId + " " + scrobble + " " + radioPlay + " "
				+ skip;
	}
